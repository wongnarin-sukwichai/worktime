    ...
    <div class="p-16 shadow-inner bg-gradient-to-r from-rose-400 to-orange-300">
        <div class="p-8 bg-white shadow-lg mt-24">
            <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                >
                    <router-link
                        class="rounded-full px-8 py-4 text-sky-300 outline outline-offset-0 outline-1 hover:bg-sky-400 hover:text-gray-50 text-4xl"
                        to="/"
                    >
                        เข้างาน
                    </router-link>
                    <router-link
                        class="rounded-full bg-orange-300 px-8 py-4 text-gray-50 hover:bg-orange-400 text-4xl"
                        to="checkout"
                    >
                        ออกงาน
                    </router-link>
