    ...
    <div class="p-16 bg-orange-50 shadow-inner">
        <div class="p-8 bg-white shadow-lg mt-24">
            <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                >
                    <router-link
                        class="rounded-full px-8 py-4 text-sky-300 outline outline-offset-0 outline-1 hover:bg-sky-400 hover:text-gray-50"
                        to="/"
                    >
                        เข้างาน
                    </router-link>
                    <router-link
                        class="rounded-full bg-orange-300 px-8 py-4 text-gray-50 hover:bg-orange-400"
                        to="checkout"
                    >
                        ออกงาน
                    </router-link>
